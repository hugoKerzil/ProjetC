...
int main(void) {
    ...
    if (strcmp(words2->word, "tata\n") && words2->occurrences == 1) {
        printf("C'est bon\n");
    } else {
        printf("C'est pas bon\n");
    }
    ...
    if (strcmp(words3->word, "tutu\n") && words3->occurrences == 2) {
        printf("C'est bon\n");
    } else {
        printf("C'est pas bon\n");
    }
    ...
    if (strcmp(words4->word, "tutu\n") && words4->occurrences == 2) {
        printf("C'est bon\n");
    } else {
        printf("C'est pas bon\n");
    }
    ...
    if (strcmp(words7->word, "tutu\n") && words7->occurrences == 3) {
        printf("C'est bon\n");
    } else {
        printf("C'est pas bon\n");
    }
    ...
    if (strcmp(words6->word, "tutu\n") && words6->occurrences == 3) {
        printf("C'est bon\n");
    } else {
        printf("C'est pas bon\n");
    }
